...
A simple todo list website with user authentication.
...
```sh
cd my-folder
git clone https://github.com/preciousbetine/microverse-react-todo-app.git
```
...
I would like to thank [Ibaslogic](https://github.com/ibaslogic) for his comprehensive react tutorial.
